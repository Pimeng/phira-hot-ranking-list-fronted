...
export default function RankingCard({ chart, index, delay = 0 }: RankingCardProps) {
  ...
  return (
    ...
    >
      <div
        className={`relative flex items-center gap-3 md:gap-5 px-4 md:px-6 py-3 md:py-4 rounded-2xl md:rounded-3xl transition-all duration-300 overflow-hidden ${
      ...
      >
          ...
          {isTop1 && (
            <div className="absolute inset-0 pointer-events-none">
              <div
                ...
                style={{
                  boxShadow: "inset 0 0 16px rgba(0,240,255,0.25)",
                }}
              />
            </div>
          )}
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Level + Rating - mobile: single row */}
